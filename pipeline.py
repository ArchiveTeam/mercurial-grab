...
LUA_SHA1 = get_hash(os.path.join(CWD, 'mercurial.lua'))
...
project = Project(
    title = 'Mercurial',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://www.archiveteam.org/images/f/f8/Mercurial-logo.png" height="50px"/>
    <h2>www.mercurial-scm.org <span class="links"><a href="https://www.mercurial-scm.org/">Website</a> &middot; <a href="http://tracker.archiveteam.org/mercurial/">Leaderboard</a></span></h2>
    '''
)
